...
class Pokes(models.Model):
    userpoke = models.ForeignKey(User, related_name="haspoked", blank=True, null=True, on_delete=models.SET_NULL)
    userpoked = models.ForeignKey(User, related_name="poked", blank=True, null=True, on_delete=models.SET_NULL) 
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)